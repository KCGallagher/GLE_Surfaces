...
#endif
typedef struct { real_T aozy4iaksv ; real_T apwemeo1pz ; real_T k0aotrxxhp [
2 ] ; real_T bkxfqi0pxq [ 2 ] ; real_T a01jyq3kex [ 2 ] ; real_T akgj1ibwf3 [
2 ] ; real_T h0heujskh3 ; real_T ldr2mikqjb ; real_T bhc54zc0ex ; real_T
auxnwxtfvo ; real_T jruwlwzzf4 ; real_T eprwmaok5p ; real_T er40lujdmg ;
real_T czszrqhgbn [ 2 ] ; real_T awprf41k1q [ 2 ] ; int16_T lg50ovp1y5 ;
int16_T iver2udidl ; boolean_T ea2wltz1rm [ 2 ] ; } B ; typedef struct {
real_T kash4ux1pw ; real_T cfhfmokiqc ; real_T kwcy3yjcpg ; real_T lblnmgrqpb
; real_T kyo5azbgia [ 2 ] ; real_T ahvyf2z4j5 [ 2 ] ; real_T g1dnqdyxsu ;
real_T df1mxqbe3i ; struct { void * LoggedData ; } ml3whhvhfc ; struct { void
* LoggedData ; } gdtp522pfd ; struct { void * LoggedData ; } afkq2ccnyz ;
struct { void * LoggedData ; } c43cp3qtjl ; uint32_T nkihzgokkq [ 2 ] ;
uint32_T aordumbgtk ; uint32_T iusooyak1q ; } DW ; typedef struct {
...
real_T DiscreteTimeIntegrator2_gainval_pfp1n5ezxj ; real_T
...
zeros_Value ; real_T ones_Value_a523d0oiup ; real_T mass_Value_ay4mlzeqvo ;
real_T zeros_Value_ljr13py54z ; real_T Interactions_Value [ 2 ] ; uint32_T
