...
%pot_strct(1).V = [13;5;5;0;3;3]; % top, slope1,slop2,bridge,hcp,fcc, COPPER - WARD THESIS
%pot_strct(1).V = [13;5;5;0;3;3]*10; % top, slope1,slop2,bridge,hcp,fcc, STRONG COPPER 
