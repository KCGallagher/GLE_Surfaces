...
TARGET_STRING ( "Coloured Noise" ) , 0 , 0 , 0 , 0 , 1 } , { 11 , 0 ,
...
"Forces" ) , 0 , 0 , 0 , 0 , 1 } , { 13 , 0 , TARGET_STRING (
...
"Forces" ) , 0 , 0 , 0 , 0 , 1 } , { 19 , 0 , TARGET_STRING (
...
rtDimensionArray [ ] = { 2 , 10 , 1 , 10 , 2 , 2 , 1 , 2 , 50 , 30 , 1 , 50 ,
1 , 30 , 2 , 1 , 1 , 1 , 2 , 10 , 2 } ; static const real_T
...
, rtSampleTimeMap , rtDimensionArray } , "float" , { 3896388283U ,
3404973259U , 478048312U , 2804755132U } , ( NULL ) , 0 , 0 } ; const
