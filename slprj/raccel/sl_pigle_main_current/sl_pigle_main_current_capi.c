...
} ; static const uint_T rtDimensionArray [ ] = { 2 , 25 , 1 , 25 , 1 , 1 , 1
, 2 , 50 , 30 , 1 , 50 , 1 , 30 , 2 , 1 , 1 , 25 , 2 } ; static const real_T
...
, rtSampleTimeMap , rtDimensionArray } , "float" , { 2791022507U ,
1465343216U , 2790501777U , 3528418953U } , ( NULL ) , 0 , 0 } ; const
