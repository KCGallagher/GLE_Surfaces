...
dimensions , NO_LOGVALDIMS , ( NULL ) , ( NULL ) , 0 , 10 , 0.0001 , 1 ) ; if
...
, 2 , dimensions , NO_LOGVALDIMS , ( NULL ) , ( NULL ) , 0 , 10 , 0.0001 , 1
...
ssSetChecksumVal ( rtS , 0 , 2403086827U ) ; ssSetChecksumVal ( rtS , 1 ,
732216877U ) ; ssSetChecksumVal ( rtS , 2 , 3422732854U ) ; ssSetChecksumVal
( rtS , 3 , 2989914644U ) ; }
#if defined(_MSC_VER)
#pragma optimize( "", off )
#endif
...
ssSetTStart ( rtS , 0.0 ) ; ssSetTFinal ( rtS , 58.191 ) ; { static
...
2403086827U ) ; ssSetChecksumVal ( rtS , 1 , 732216877U ) ; ssSetChecksumVal
( rtS , 2 , 3422732854U ) ; ssSetChecksumVal ( rtS , 3 , 2989914644U ) ; {
